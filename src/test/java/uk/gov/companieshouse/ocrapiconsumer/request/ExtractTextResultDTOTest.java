...
class ExtractTextResultDTOTest extends TestParent {
    ...
    void testCreateErrorExtractTextResultDTOFromContextId() {
        ExtractTextResultDTO extractTextResultDTO = ExtractTextResultDTO.createErrorExtractTextResultDTOFromContextId(CONTEXT_ID);
        ...
        assertThat(extractTextResultDTO.getResponseId(), is(CONTEXT_ID));
